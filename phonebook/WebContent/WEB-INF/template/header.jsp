...
<div id="header">
	<h1>
		<a href="/index.jsp">
			<img src="/img/${loginMember.profileImage}" class="profile"/>
	...
	<div id="nav">
		...
		<ul>
		 ...
		 --><li <%if(uri.equals("/main.jsp")
				 ||uri.equals("/")
				 ||uri.equals("/updateForm.jsp")){%>class='on' <% } %>><a href="/main.jsp"><i class="fas fa-mobile"></i> 전화번호부</a></li><!--
		 --><li <%if(uri.equals("/registerForm.jsp")){%>class='on' <% } %>><a href="/registerForm.jsp"><i class="fas fa-pencil-alt"></i> 전화번호 작성</a></li>
		</ul>
	</div><!-- //nav -->
	
	<a href="/logout.bmj" class="btn logout">
